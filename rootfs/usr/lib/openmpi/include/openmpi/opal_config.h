...
#define CRS_BLCR_HAVE_CR_REQUEST 1

/* BLCR cr_request_checkpoint check */
#define CRS_BLCR_HAVE_CR_REQUEST_CHECKPOINT 1

/* BLCRs cr_checkpoint_info.requester member availability */
#define CRS_BLCR_HAVE_INFO_REQUESTER 1
...
#define MCA_hwloc_IMPLEMENTATION_HEADER "/usr//include/hwloc.h"

/* Complete set of command line arguments given to ROMIOs configure script */
#define MCA_io_romio_COMPLETE_CONFIGURE_FLAGS " CFLAGS='-DNDEBUG -g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security -finline-functions -fno-strict-aliasing -pthread' CPPFLAGS=' -I/usr//include   -I/usr/include/infiniband -I/usr/include/infiniband' FFLAGS='-g -O2' LDFLAGS='-Wl,-Bsymbolic-functions -Wl,-z,relro  -L/usr//lib' --enable-shared --disable-static  --prefix=/usr --with-mpi=open_mpi --disable-aio"
...
#define OPAL_ARCH "i686-pc-linux-gnu"
...
/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION 264194

/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION_STR 4.8.2
...
#define OPAL_ENABLE_FT_CR 1

/* Enable fault tolerance thread in Open PAL */
#define OPAL_ENABLE_FT_THREAD 1
...
#define OPAL_LIBLTDL_INTERNAL 0
...
#define OPAL_PACKAGE_STRING "Open MPI buildd@batsu Distribution"
...
#define WRAPPER_EXTRA_LDFLAGS " -L/usr//lib "

/* Additional LIBS to pass through the wrapper compilers */
#define WRAPPER_EXTRA_LIBS "-ldl  -lhwloc "
