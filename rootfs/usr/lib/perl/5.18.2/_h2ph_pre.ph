...
unless (defined &__SIZEOF_LONG_DOUBLE__) { sub __SIZEOF_LONG_DOUBLE__() { 12 } }
...
unless (defined &__VERSION__) { sub __VERSION__() { "\"4\.8\.2\"" } }

unless (defined &__WCHAR_MAX__) { sub __WCHAR_MAX__() { 2147483647 } }

unless (defined &__WCHAR_MIN__) { sub __WCHAR_MIN__() { "\-2147483647L\\\ \-\\\ 1" } }
...
unless (defined &__code_model_32__) { sub __code_model_32__() { 1 } }
...
unless (defined &__i686) { sub __i686() { 1 } }

unless (defined &__i686__) { sub __i686__() { 1 } }

unless (defined &__linux) { sub __linux() { 1 } }

unless (defined &__linux__) { sub __linux__() { 1 } }

unless (defined &__pentiumpro) { sub __pentiumpro() { 1 } }

unless (defined &__pentiumpro__) { sub __pentiumpro__() { 1 } }
